    ...
    <div class="login-layout">
      ...
      <div class="login-left">
        <div class="brand">
          ...
          <span class="brand-name">DesignMarket</span>
        </div>
        <div class="brand-content">
          <h2>다시 만나서<br>반갑습니다</h2>
          <p>로그인하고 나만의 디자인 마켓을 이어가세요.</p>
      ...
      <div class="login-right">
        <div class="login-box fade-in-up">
          ...
          <div v-if="!showRegister" class="section">
            ...
            <p class="section-desc">DesignMarket 계정으로 로그인합니다.</p>
            ...
            <form @submit.prevent="handleRegister" class="form">
              ...
              <div class="form-group">
                ...
                <select v-model="registerForm.role" class="form-input">
                  <option value="STUDENT">구매자</option>
                  <option value="INSTRUCTOR">디자이너</option>
                </select>
              </div>
...
const features = ['구매한 디자인 다운로드', '맞춤 디자인 추천', '판매 내역 관리']
